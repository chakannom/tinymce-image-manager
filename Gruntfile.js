...
module.exports = function(grunt) {
  ...
  const appPath = 'src/app/js/app.js';
  const appMinPath = 'scratch/compiled/app/js/app.min.js';
  ...
  grunt.initConfig({
    ...
    concat: {
      license: {
        ...
        files: {
          'dist/cks_image/plugin.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ],
          'dist/cks_image/plugin.min.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ]
        }
    ...
    copy: {
      css: {
        files: [
          ...
          { src: ['changelog.txt'], dest: 'dist/cks_image', expand: true },
          {
            cwd: 'src',
            src: ['app/css/*'],
            dest: 'dist/cks_image',
      ...
      html: {
        ...
        options: {
          process: function (content, srcpath) {
            return content.replace(/app.js/g, 'app.min.js');
          }
        }
      }
    },
  ...
  grunt.registerTask('version', 'Creates a version file', function () {
    grunt.file.write('dist/cks_image/version.txt', BUILD_VERSION);
  });
